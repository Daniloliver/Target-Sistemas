const faturamentoDiario = [
  ...
  const mediaMensal = somaValores / faturamentoDiario.length;
  
  // Conta o número de dias em que o valor diário foi superior à média mensal
  ...
  console.log(`Menor valor diário: ${menor}`)
